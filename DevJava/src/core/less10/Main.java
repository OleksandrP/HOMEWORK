...
//	public static void main(String[] args) { // set -множина.  не приймає одинакові значення микола і микола два різні миколи.
...
//		set.add(new Person("Mykola", 21, Gender.MALE));
//		System.out.println(set);  // щоб вивести форіч та еквелс.  ctrl+мишка 
//		
...
//	}
	...
	public static void main(String[] args) {
		...
		while(true){
			System.out.println("Enter 1 by sort by name asc");
	...
	static Stream<Person> sortByNameAsc(){   // implanment  в personi/ 6урок 
